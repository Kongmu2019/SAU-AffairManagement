...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo"><img src="images/logo.jpg" class="layui-nav-img">宣传部界面</div>
    ...
    <ul class="layui-nav layui-layout-right">
      ...
      <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/LoginOutServlet?type=shelian6">退出登录</a></li>
    </ul>
  </div>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
       <li class="layui-nav-item"><a href="shelian/poster_check.html" target="iframeMain">活动海报审核</a></li>
       <li class="layui-nav-item"><a href="shelian/news_check.html" target="iframeMain">活动新闻稿审核</a></li>
       <li class="layui-nav-item"><a href="shelian/activity_submit.html" target="iframeMain">发布最新活动</a></li>
...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        <div class="layadmin-tabsbody-item layui-show">
            <iframe src="shelian/xuanchuanbu_default.html" class="layadmin-iframe" name="iframeMain" id="iframeBody"></iframe>
        </div>
    </div>
</div>
