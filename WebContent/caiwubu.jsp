...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo"><img src="images/logo.jpg" class="layui-nav-img">财务部界面</div>
    ...
    <ul class="layui-nav layui-layout-right">
      ...
      <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/LoginOutServlet?type=shelian2">退出登录</a></li>
    </ul>
  </div>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
       <li class="layui-nav-item"><a href="shelian/account_claim.html" target="iframeMain">社团财务报账</a></li>
       <li class="layui-nav-item"><a href="shelian/account_expense.html" target="iframeMain">社联财务报销</a></li>
       <li class="layui-nav-item"><a href="shelian/expense_check.html" target="iframeMain">活动经费审核</a></li>
...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        <div class="layadmin-tabsbody-item layui-show">
            <iframe src="shelian/caiwubu_default.html" class="layadmin-iframe" name="iframeMain" id="iframeBody"></iframe>
        </div>
    </div>
</div>
