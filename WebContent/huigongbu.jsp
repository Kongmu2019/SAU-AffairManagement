...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo"><img src="images/logo.jpg" class="layui-nav-img">会员工作部界面</div>
    ...
    <ul class="layui-nav layui-layout-right">
      ...
      <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/LoginOutServlet?type=shelian3">退出登录</a></li>
    </ul>
  </div>
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          <a class="" href="javascript:;">会员反馈管理</a>
          <dl class="layui-nav-child">
            <dd><a href="shelian/advice_submit.html" target="iframeMain">提交会员意见</a></dd>
            <dd><a href="shelian/complaint_handle.html" target="iframeMain">处理会员投诉</a></dd>
          </dl>
        </li>
         <li class="layui-nav-item">
          <a class="" href="javascript:;">社团会员信息管理</a>
          <dl class="layui-nav-child">
            <dd><a href="shelian/new_member.html" target="iframeMain">新增会员信息</a></dd>
            <dd><a href="shelian/modify_member.html" target="iframeMain">修改会员信息</a></dd>
            <dd><a href="shelian/delete_member.html" target="iframeMain">删除会员信息</a></dd>
          </dl>
        </li>
...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        <div class="layadmin-tabsbody-item layui-show">
            <iframe src="shelian/huigongbu_default.html" class="layadmin-iframe" name="iframeMain" id="iframeBody"></iframe>
        </div>
    </div>
</div>
